<template>
        <div ref="searchDiv" class="flex h-[55px] w-[819px] border border-[#162C40]">
            ...
            <div class="searchInput w-full flex items-center px-[53px]">
                <input @input="search"  type="text" class="placeholder:text-[#797171] w-full outline-none" placeholder="Поиск...">
            </div>
...
<script setup>
    ...
    async function search(){
        // searchDiv.value.classList.add("search")
    }
    onMounted(async() => {
        await getTab();
    })
