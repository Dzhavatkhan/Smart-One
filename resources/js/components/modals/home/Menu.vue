<template>
    <img @click="show = !show" src="/public/img/home/header/Menu.svg" alt="" class="hidden max-sm:flex max-sm:w-5">

    <div class="catalog fixed inset-0 m-auto bg-white z-20" v-show="show">
        <div class="w-max fixed inset-0 m-auto z-20 flex justify-center items-center">
            <div class="w-full h-full px-5 py-[10px] flex flex-col gap-5">
                ...
                <div class="menu flex flex-col items-start gap-10 py-10">
                    <select name="" id="" class="city outline-none bg-transparent w-full">
