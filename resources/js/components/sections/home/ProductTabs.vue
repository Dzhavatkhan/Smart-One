<template>
    <div class="productTabs flex flex-col gap-[55px] max-md:gap-[17px] max-sm:gap-[17px] max-md:px-5 max-md:w-screen max-md:mt-[55px] max-sm:px-5 max-sm:w-screen max-sm:mt-[55px]">
        ...
        <div v-if="accessories.length > 0 && accessories != null" id="accessoriesContent" class="tabcontent pb-5 w-full h-full gap-[38.07px] max-sm:gap-x-0 max-sm:gap-y-5 max-sm:justify-between flex flex-wrap">
