<template>
    ...
    <div v-for="product in favorites" :key="product.id" class="product w-[275.05px] h-[351px] duration-200 hover:shadow-lg bg-white shadow-md border-t border-gray-200 flex flex-col max-sm:w-[185px] max-sm:h-[274px]">
        <div class="p-image w-full h-[187px] flex justify-center items-center">
            <img @click="favorite(product.id)" src="/public/img/home/main/Delete.svg" class="relative cursor-pointer z-10 left-52 bottom-7 max-sm:left-[115px] max-sm:bottom-7" alt="">
        ...
        <div class="p-info gap-[17px] pl-[19px] pr-[12px] w-full h-full flex flex-col max-sm:gap-0 max-sm:justify-between">
            ...
            <div class="p-price flex justify-between items-center pb-6 max-sm:pb-[9px]">
                ...
                <img src="/public/img/home/main/addCart.svg" alt="" class="addCart cursor-pointer w-8 h-8 max-sm:w-10 max-sm:h-10">
            </div>
        </div>
    </div>
</template>
